...
local function TableToString(t, indent)
    ...
    local isEmpty = true
    for _ in pairs(t) do isEmpty = false; break end
    if isEmpty then return " {}\n" end

    -- If we are here, the table has content
    str = "\n" -- Start on a new line for nested tables
    for k, v in pairs(t) do
        if type(v) == "table" then
            str = str .. indent .. "  " .. k .. ":" .. TableToString(v, indent .. "  ")
        else
